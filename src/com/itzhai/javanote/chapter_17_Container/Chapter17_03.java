 ...
 *   3 Collection的功能方法
 *     
 * 可以通过Collection执行的所有操作：002，因此，它也是可通过Set或List执行的所有操作（List）还有额外的功能，Map不是继承自Collection的
 * 
 * 这些方法中不包括随机访问所选择元素的get()方法，因为Collection包括Set，Set是自己维护内部顺序的，如果想检查Collection中的元素，就必须使用迭代器。
 * 
 * 下面以ArrayList为例子，演示这些方法的使用：
 */
